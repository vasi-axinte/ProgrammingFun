...
namespace Server.Migrations
{
    ...
    [Migration("20201211143653_UserAnswerChanges")]
    partial class UserAnswerChanges
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.UserAnswer", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("UserId", "QuizId", "QuestionId");
            ...
            modelBuilder.Entity("Server.Models.UserAnswer", b =>
                {
                    ...
                    b.HasOne("Server.Models.QuizQuestion", "QuizQuestion")
                        .WithMany("UserAnswer")
